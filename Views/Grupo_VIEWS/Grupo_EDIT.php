...
class Grupo_EDIT
{
    ...
    function pinta()
    {
        ...
        //Si el usuarios está autenticado pero no es administrador 
            if (IsAuthenticated() && !isAllow('Group','Edit')){
        ...
        <form id="formulario-edit" name="formulario_edit" method="post" onSubmit="return validarEntidad('grupo','edit')">
            ...
            <label><?php echo $strings['Descripcion'];?>
                <textarea form="formulario-edit" maxlength="100" required="true" name="DescripGrupo" ><?php echo $this->lista_valores['DescripGrupo'] ?></textarea>
            </label>
