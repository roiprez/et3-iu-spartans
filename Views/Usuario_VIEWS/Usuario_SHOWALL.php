...
class Usuario_SHOWALL{  // declaración de clase
    ...
    function pinta(){
        include '../Locales/Strings_'.$_SESSION['idioma'].'.php';
            ...
            if (IsAuthenticated() && !isAllow('Usu','ShowAll')){
            ...
            while($row = $this->datos->fetch_array())
            {
                ...
                <form class="formulario-tupla" method="">
                    <tr>
                        ...
                        <td><button type = "submit" name = "action" value="ADDGROUP" title="<?php echo $strings['editar grupos']; ?>"><img class="button-td" src="../Iconos/group_add.png" ></img></button></td>
