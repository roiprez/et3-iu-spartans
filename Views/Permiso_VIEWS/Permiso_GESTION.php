...
class Permiso_GESTION// declaración de clase
{
    ...
    function pinta()
    {
        ...
        if (IsAuthenticated() && !isAllow('Perm','Gest')){
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><div class="botones-formulario">
                            <button id="enviar" name = "action" value = "ADDPERMISO" type="submit" title="<?php echo $strings['enviar']; ?>"><img class="button-td" src="../Iconos/send.png" ></button>
